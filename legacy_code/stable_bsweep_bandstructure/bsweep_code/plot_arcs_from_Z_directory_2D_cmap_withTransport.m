...
for i = 1:size(Zstore,3)
    ...
    plot(B_exp(1:i),ohmNumsp1(1:i,2)/2,'r');
    plot(B_exp(1:i),ohmNumsm1(1:i,2)/2,'b');
...
%     ylim([-0.05,0.35])
    ...
    plot(B_exp(1:i),(ohmNumsp1(1:i,2)+ohmNumsp1(1:i,4))/2,'r');
    plot(B_exp(1:i),(ohmNumsm1(1:i,2)+ohmNumsm1(1:i,4))/2,'b');
...
% 
    ...
    if save_plots
        ...
        imwrite(imind,cm,[dirpath,savedir, '/PNGOHM/',savedir,'_', num2str(i), '_PNG.png'])
        
        if i == 1
            imwrite(imind,cm,[dirpath,savedir, '/PNGOHM/',savedir,'.gif'],'gif', 'Loopcount',Inf,'DelayTime',1/frame_rate);
        elseif i == size(Zstore,3)
            imwrite(imind,cm,[dirpath,savedir, '/PNGOHM/',savedir,'.gif'],'gif','WriteMode','append','DelayTime',1/frame_rate);
        else
            imwrite(imind,cm,[dirpath,savedir, '/PNGOHM/',savedir,'.gif'],'gif','WriteMode','append','DelayTime',1/frame_rate);
        end
